...
git:
	@echo "Pushing commit \"${push}\" to ${GIT_REPOSITORY}/auth-service"
	@cd ../auth-service && git add . && git commit --allow-empty -m ${push} && git push
	@echo "Commit \"${push}\" pushed"
	@echo "Pushing commit \"${push}\" to ${GIT_REPOSITORY}/log-service"
	@cd ../log-service && git add . && git commit --allow-empty -m ${push} && git push
	@echo "Commit \"${push}\" pushed"
	@echo "Pushing commit \"${push}\" to ${GIT_REPOSITORY}/broker-service"
	@cd ../broker-service && git add . && git commit --allow-empty -m ${push} && git push
	@echo "Commit \"${push}\" pushed"
	@echo "Pushing commit \"${push}\" to ${GIT_REPOSITORY}/listener-service"
	@cd ../listener-service && git add . && git commit --allow-empty -m ${push} && git push
	@echo "Commit \"${push}\" pushed"
	@echo "Pushing commit \"${push}\" to ${GIT_REPOSITORY}/verifire-frontend"
	@cd ../verifire-frontend && git add . && git commit --allow-empty -m ${push} && git push
	@echo "Commit \"${push}\" pushed"
	@echo "Pushing commit \"${push}\" to ${GIT_REPOSITORY}/verifire-scripts"
	@cd ../verifire-scripts && git add . && git commit --allow-empty -m ${push} && git push
	@echo "Commit \"${push}\" pushed"
